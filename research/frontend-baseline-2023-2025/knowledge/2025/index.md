...
- **Период**: 1 января — 18 ноября 2025 (11 месяцев)
- **Research ID**: `frontend-baseline-2023-2025`
- **Дата создания**: 19 ноября 2025

> Внимание Данный обзор охватывает **частичный год** (январь — ноябрь 2025) и представляет состояние
> веб-платформы на момент исследования.
