...
**Web Platform Baseline** — инициатива, запущенная в **2023 году**, которая предоставляет разработчикам чёткую информацию о межбраузерной совместимости веб-платформенных функций.
...
Функции группируются в ежегодные **Baseline targets** в зависимости от года, в котором они достигли статуса **Newly Available**:
...
**Interop** (ежегодная инициатива браузеров для улучшения совместимости) и **Baseline** тесно связаны:
...
- Примеры: Container Queries (Interop 2022 → Baseline 2023), CSS Nesting (Interop 2023 → Baseline 2023)
