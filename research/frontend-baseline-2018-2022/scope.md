...
description: Границы, методология и критерии отбора для исследования Веб-технологии 2018-2022
outline: deep
lastUpdated: true
---

# Scope исследования: Веб-технологии 2018–2022
...
- Достигли **baseline статуса** (поддержка во всех основных браузерах) к концу 2022 или в течение
  этого периода
...
**Критерий baseline:** Фича считается baseline, когда поддерживается во всех четырёх основных
браузерах (последние 2 major версии на момент оценки).
...
3. **Субъективность значимости:** Оценка влияния основана на анализе community feedback и экспертных
   мнений
...
1. **Самостоятельного изучения** разработчиком, который хочет восполнить пробелы в знаниях за
   2018–2022
