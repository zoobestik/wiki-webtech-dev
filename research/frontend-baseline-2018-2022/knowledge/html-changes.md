...
<input type="text" inputmode="text">      <!-- Стандартная клавиатура -->
<input type="text" inputmode="decimal">   <!-- Числа с десятичной точкой -->
<input type="text" inputmode="numeric">   <!-- Только цифры -->
<input type="text" inputmode="tel">       <!-- Телефонная клавиатура -->
<input type="text" inputmode="email">     <!-- Email клавиатура (с @) -->
<input type="text" inputmode="url">       <!-- URL клавиатура (с .com, /) -->
<input type="text" inputmode="search">    <!-- Поисковая клавиатура -->
```
